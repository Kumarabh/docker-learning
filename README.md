...
-> No other container should connect connect to secure network (custom bridge n/w) or talk to containers connected to secure network as these container have sensitive information.
